...
class saveselector:
    ...
    class Slider:
        def __init__(self, loading_save_screen):
            ...
            self.section_height = self.display.container_height // self.num_sections
            self.slider_height = self.section_height
            self.slider_pos = 0
            self.screen = self.display.game.screen
            self.display.game.objects.append(self)
        def render(self):
            pygame.draw.rect(self.screen, (255, 255, 255), (0, 0, 20, self.section_height))
            pygame.draw.rect(self.screen, (0, 0, 255),
                             (0, self.slider_pos * self.section_height, 20, self.slider_height))