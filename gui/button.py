    ...
    def checkifclicked(self, mousepos):
        ...
        if self.rect.collidepoint(mousepos[0], mousepos[1]):
            if self.number == 0:
                ...
                obj = gameobjects.oldFlashlight(self.game, [(mousepos[0], mousepos[1]), (mousepos[0] + 200, mousepos[1]), (mousepos[0] + 200, mousepos[1] + 100), (mousepos[0], mousepos[1] + 100)], (255, 255, 255), 0, image=images.laser)
                self.game.current_flashlight = obj

            elif self.number == 2:
                obj = gameobjects.Mirror(self.game, [(mousepos[0] - 100, mousepos[1] - 50), (mousepos[0] + 100, mousepos[1] - 50), (mousepos[0] + 100, mousepos[1] + 50), (mousepos[0] - 100, mousepos[1] + 50)], (255, 0, 0), 0, texture = images.wood)
